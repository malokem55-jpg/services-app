...
// كرت «تعبئة مقيم على الآيفون» (الزر السحري / Bookmarklet) + نافذة الإرشادات.
// يُعاد استخدامه في لوحة malik (تاب تشغيل على الهاتف) وفي شاشة /m/settings.
export default function MuqeemFillCard() {
